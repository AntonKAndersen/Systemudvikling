...
ID int not null auto_increment, -- lokaleID er en integer der tæller automatisk op
...
universitet varchar (50) null, -- accepterer strings på længden op til 50
primary key (ID) -- den primære nøgle er ID
);

-- Indsætter 6 lokaler i tabellen
